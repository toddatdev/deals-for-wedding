...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('vendor.category.listing',compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            return redirect()->route('vendor.categories.index')->with('success','Category has been saved successfully.');
        }catch(\Throwable $e){
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('vendor.categories.index')->with('success','Category has been deleted successfully.');
    }
