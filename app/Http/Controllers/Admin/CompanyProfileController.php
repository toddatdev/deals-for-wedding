...
class CompanyProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.advertiser.company_profile', compact('fields', 'vendor'));
    }
    ...
    public function update(Request $request, $vendor_id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.edit-advertiser', $vendor_id)->with('success', 'Company Profile has been updated');
        } catch (\Throwable $e) {
            // dd($e->getMessage());
