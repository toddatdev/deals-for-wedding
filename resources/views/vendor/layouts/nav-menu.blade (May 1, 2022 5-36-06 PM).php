	...
	<nav class="navbar navbar-header navbar-expand-lg">
		<div class="container-fluid">
			...
			<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
				<li class="nav-item"><a class="nav-link" href="{{route('vendor.cart')}}"><i class="la la-shopping-cart"></i>
						...
						<li>
							<div class="notif-center">
								...
								<a id="notify_{{$notification->id}}" class="notifyaccess" href="javascript:;">
									<div style="width: 50px" class="notif-icon notif-primary"> <i class="la la-bell"></i> </div>
...
<li>
	<a class="see-all" href="{{route('vendor.notifications')}}"> <strong>See all notifications</strong> <i
...
<li class="nav-item dropdown"> 
	<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
		@if(isset($vendorimagenav))
		<img src="{{asset('public/'.$vendor->userDetails->image)}}" alt="user-img" width="36"
			class="img-circle"><span>{{ $vendor->fname }} {{ $vendor->lname }}</span>
			
			@foreach ($vendorimagenav as $key => $item)
			{{$item}}
			@endforeach
		@else
		<img src="{{asset('public/admin/img/profile.jpg')}}" alt="user-img" width="36"
			class="img-circle"><span>{{ $vendor->fname }} {{ $vendor->lname }}</span>
		@endif
	</a>
