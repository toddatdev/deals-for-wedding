                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="phone form-control @error('phone') is-invalid @enderror" id="phone" name="phone" placeholder="Phone" value="{{(isset($userDetails) && !empty($userDetails->userDetails->phone)) ? $userDetails->userDetails->phone : ''}}" required="">
                                                @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
