								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-12 mb-3">
											<label for="image" class="form-label"><strong>Image</strong><small> Required square
													size & minimum 300px width. Allowed image type (jpeg, jpg, png, gif)</small></label>
											@if(isset($deal->image))
												<div class="old_img">
													<img src="{{asset($deal->image)}}" style="width:100px">
													<i class="fa fa-times text-success" aria-hidden="true" onclick="removeFile(this);">Remove</i>
												</div>
											@endif
											<input type="file" id="image" name="image" class="form-control" accept=".jpeg,.jpg,.png,.gif" required="required" />
